...
import guestproductmodal from "./guestProductmodal.js";
import cart from "./cart.js";
import inputForm from "./inputGuestInfoPage.js";
const app = Vue.createApp({
  ...
  methods: {
    ...
    guestPorductDetal(id){
      this.$refs.guestModal.guestModalOpen(id);
    },
    getGuestProduct(){
      axios.get(`${this.apiInfo.url}/api/${this.apiInfo.path}/products/all`).then((res)=>{
